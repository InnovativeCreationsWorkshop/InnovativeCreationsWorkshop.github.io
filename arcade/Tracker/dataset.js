...
//
// SCORING VALUES (uniform as of latest revision):
//   protein   = 15
//   veg       = 10
//   hydration = 2
//   carbs     = 0
//   diabetic-friendly dessert     = 5  (incl. dark chocolate)
//   non-diabetic-friendly dessert = -40
// =====================================================================
...
// =====================================================================
//
// NOTE: Composite dishes (pizza, pasta, noodles, cornbread, ramen
// noodles, etc.) live in mealDataset, NOT here — keeping them out of
// foodDataset prevents them from shadowing the richer multi-category
// mealDataset entries during lookup (food is checked before meal in
// lookupItem()).

const foodDataset = {
    // ---- Protein (value: 15) ----
    "chicken": { category: "protein", value: 15 },
    "chicken breast": { category: "protein", value: 15 },
    "chicken thigh": { category: "protein", value: 15 },
    "chicken drumstick": { category: "protein", value: 15 },
    "chicken wing": { category: "protein", value: 15 },
    "ground chicken": { category: "protein", value: 15 },
    "rotisserie chicken": { category: "protein", value: 15 },
    "beef": { category: "protein", value: 15 },
    "ground beef": { category: "protein", value: 15 },
    "steak": { category: "protein", value: 15 },
    "ribeye": { category: "protein", value: 15 },
    "sirloin": { category: "protein", value: 15 },
    "brisket": { category: "protein", value: 15 },
    "short ribs": { category: "protein", value: 15 },
    "pork": { category: "protein", value: 15 },
    "pork chop": { category: "protein", value: 15 },
    "pork tenderloin": { category: "protein", value: 15 },
    "pork belly": { category: "protein", value: 15 },
    "bacon": { category: "protein", value: 15 },
    "turkey bacon": { category: "protein", value: 15 },
    "sausage": { category: "protein", value: 15 },
    "breakfast sausage": { category: "protein", value: 15 },
    "hot dog": { category: "protein", value: 15 },
    "ham": { category: "protein", value: 15 },
    "deli ham": { category: "protein", value: 15 },
    "turkey": { category: "protein", value: 15 },
    "ground turkey": { category: "protein", value: 15 },
    "deli turkey": { category: "protein", value: 15 },
    "duck": { category: "protein", value: 15 },
    "lamb": { category: "protein", value: 15 },
    "lamb chop": { category: "protein", value: 15 },
    "venison": { category: "protein", value: 15 },
    "bison": { category: "protein", value: 15 },
    "rabbit": { category: "protein", value: 15 },
    "shrimp": { category: "protein", value: 15 },
    "crab": { category: "protein", value: 15 },
    "lobster": { category: "protein", value: 15 },
    "scallop": { category: "protein", value: 15 },
    "mussel": { category: "protein", value: 15 },
    "clam": { category: "protein", value: 15 },
    "oyster": { category: "protein", value: 15 },
    "salmon": { category: "protein", value: 15 },
    "tuna": { category: "protein", value: 15 },
    "tilapia": { category: "protein", value: 15 },
    "cod": { category: "protein", value: 15 },
    "halibut": { category: "protein", value: 15 },
    "trout": { category: "protein", value: 15 },
    "mackerel": { category: "protein", value: 15 },
    "sardine": { category: "protein", value: 15 },
    "anchovy": { category: "protein", value: 15 },
    "fish": { category: "protein", value: 15 },
    "eel": { category: "protein", value: 15 },
    "egg": { category: "protein", value: 15 },
    "egg white": { category: "protein", value: 15 },
    "tofu": { category: "protein", value: 15 },
    "firm tofu": { category: "protein", value: 15 },
    "silken tofu": { category: "protein", value: 15 },
    "tempeh": { category: "protein", value: 15 },
    "seitan": { category: "protein", value: 15 },
    "edamame": { category: "protein", value: 15 },
    "bean": { category: "protein", value: 15 },
    "black bean": { category: "protein", value: 15 },
    "kidney bean": { category: "protein", value: 15 },
    "pinto bean": { category: "protein", value: 15 },
    "white bean": { category: "protein", value: 15 },
    "cannellini bean": { category: "protein", value: 15 },
    "navy bean": { category: "protein", value: 15 },
    "chickpea": { category: "protein", value: 15 },
    "lentil": { category: "protein", value: 15 },
    "peanut": { category: "protein", value: 15 },
    "peanut butter": { category: "protein", value: 15 },
    "almond": { category: "protein", value: 15 },
    "almond butter": { category: "protein", value: 15 },
    "walnut": { category: "protein", value: 15 },
    "cashew": { category: "protein", value: 15 },
    "pistachio": { category: "protein", value: 15 },
    "pecan": { category: "protein", value: 15 },
    "sunflower seed": { category: "protein", value: 15 },
    "pumpkin seed": { category: "protein", value: 15 },
    "chia seed": { category: "protein", value: 15 },
    "hemp seed": { category: "protein", value: 15 },
    "flax seed": { category: "protein", value: 15 },
    "cheese": { category: "protein", value: 15 },
    "cheddar": { category: "protein", value: 15 },
    "mozzarella": { category: "protein", value: 15 },
    "parmesan": { category: "protein", value: 15 },
    "feta": { category: "protein", value: 15 },
    "goat cheese": { category: "protein", value: 15 },
    "string cheese": { category: "protein", value: 15 },
    "cottage cheese": { category: "protein", value: 15 },
    "ricotta": { category: "protein", value: 15 },
    "greek yogurt": { category: "protein", value: 15 },
    "yogurt": { category: "protein", value: 15 },
    "protein shake": { category: "protein", value: 15 },
    "protein bar": { category: "protein", value: 15 },
    "protein powder": { category: "protein", value: 15 },
    "jerky": { category: "protein", value: 15 },
    "deli meat": { category: "protein", value: 15 },
    "salami": { category: "protein", value: 15 },
    "pepperoni": { category: "protein", value: 15 },
    "chorizo": { category: "protein", value: 15 },
    "meatball": { category: "protein", value: 15 },
    "protein": { category: "protein", value: 15 },
    "meat": { category: "protein", value: 15 },

    // ---- Veg (value: 10) ----
    "broccoli": { category: "veg", value: 10 },
    "carrot": { category: "veg", value: 10 },
    "tomato": { category: "veg", value: 10 },
    "cherry tomato": { category: "veg", value: 10 },
    "cucumber": { category: "veg", value: 10 },
    "lettuce": { category: "veg", value: 10 },
    "romaine lettuce": { category: "veg", value: 10 },
    "iceberg lettuce": { category: "veg", value: 10 },
    "butter lettuce": { category: "veg", value: 10 },
    "spinach": { category: "veg", value: 10 },
    "kale": { category: "veg", value: 10 },
    "arugula": { category: "veg", value: 10 },
    "swiss chard": { category: "veg", value: 10 },
    "collard greens": { category: "veg", value: 10 },
    "mustard greens": { category: "veg", value: 10 },
    "watercress": { category: "veg", value: 10 },
    "onion": { category: "veg", value: 10 },
    "green onion": { category: "veg", value: 10 },
    "red onion": { category: "veg", value: 10 },
    "white onion": { category: "veg", value: 10 },
    "yellow onion": { category: "veg", value: 10 },
    "shallot": { category: "veg", value: 10 },
    "leek": { category: "veg", value: 10 },
    "garlic": { category: "veg", value: 10 },
    "ginger": { category: "veg", value: 10 },
    "cilantro": { category: "veg", value: 10 },
    "jalapeno": { category: "veg", value: 10 },
    "serrano": { category: "veg", value: 10 },
    "habanero": { category: "veg", value: 10 },
    "poblano": { category: "veg", value: 10 },
    "thai chili": { category: "veg", value: 10 },
    "chili pepper": { category: "veg", value: 10 },
    "bell pepper": { category: "veg", value: 10 },
    "zucchini": { category: "veg", value: 10 },
    "yellow squash": { category: "veg", value: 10 },
    "butternut squash": { category: "veg", value: 10 },
    "acorn squash": { category: "veg", value: 10 },
    "pumpkin": { category: "veg", value: 10 },
    "asparagus": { category: "veg", value: 10 },
    "green bean": { category: "veg", value: 10 },
    "snap pea": { category: "veg", value: 10 },
    "snow pea": { category: "veg", value: 10 },
    "pea": { category: "veg", value: 10 },
    "corn": { category: "veg", value: 10 },
    "cabbage": { category: "veg", value: 10 },
    "red cabbage": { category: "veg", value: 10 },
    "napa cabbage": { category: "veg", value: 10 },
    "cauliflower": { category: "veg", value: 10 },
    "brussels sprout": { category: "veg", value: 10 },
    "mushroom": { category: "veg", value: 10 },
    "portobello": { category: "veg", value: 10 },
    "shiitake": { category: "veg", value: 10 },
    "seaweed": { category: "veg", value: 10 },
    "nori": { category: "veg", value: 10 },
    "bok choy": { category: "veg", value: 10 },
    "eggplant": { category: "veg", value: 10 },
    "okra": { category: "veg", value: 10 },
    "artichoke": { category: "veg", value: 10 },
    "beet": { category: "veg", value: 10 },
    "radish": { category: "veg", value: 10 },
    "turnip": { category: "veg", value: 10 },
    "parsnip": { category: "veg", value: 10 },
    "fennel": { category: "veg", value: 10 },
    "celery": { category: "veg", value: 10 },
    "pickle": { category: "veg", value: 10 },
    "sauerkraut": { category: "veg", value: 10 },
    "kimchi": { category: "veg", value: 10 },
    "tomatillo": { category: "veg", value: 10 },
    "olive": { category: "veg", value: 10 },
    "sun-dried tomato": { category: "veg", value: 10 },
    "roasted red pepper": { category: "veg", value: 10 },
    "sprouts": { category: "veg", value: 10 },
    "bean sprout": { category: "veg", value: 10 },
    "water chestnut": { category: "veg", value: 10 },
    "bamboo shoot": { category: "veg", value: 10 },
    "jicama": { category: "veg", value: 10 },
    "daikon": { category: "veg", value: 10 },
    "salad greens": { category: "veg", value: 10 },
    "microgreens": { category: "veg", value: 10 },
    "avocado": { category: "veg", value: 10 },
    "veg": { category: "veg", value: 10 },
    ...
    "espresso": { category: "hydration", value: 2 },
    ...
    "sports drink": { category: "hydration", value: 2 },
    "energy drink": { category: "hydration", value: 2 },
    "soda": { category: "hydration", value: 2 },
...
const foodAliases = {
    ...
    // NOTE: "chicken wings" intentionally NOT aliased here — it's a
    // mealDataset entry (["protein"]) and should resolve there, not
    // collapse into the single-ingredient "chicken wing" food entry.
    "steaks": "steak",
...
const mealAliases = {
    ...
    // NOTE: "donut": "donburi" alias intentionally removed — it was
    // incorrectly routing "Donuts" to the rice-bowl dish instead of
    // the nonDiabeticDesserts "donut" entry (-40).
};
...
// ✅ Diabetic-friendly desserts (value: 5, uniform — incl. dark chocolate)
const diabeticFriendlyDesserts = {
    ...
    "dark chocolate": { category: "dessert", value: 5 },
...
// ❌ Non-diabetic-friendly desserts (value: -40, uniform)
...
// EXAMPLE USAGE
// =====================================================================
// lookupItem("Veggies")                -> { type: "food", key: "veg", category: "veg", value: 10 }
// lookupItem("VEGTABLES")              -> same as above
// lookupItem("grilled chicken breast") -> { type: "food", key: "chicken breast", category: "protein", value: 15 }
...
// lookupItem("Tacos")                  -> { type: "meal", key: "taco", categories: ["protein","veg","carbs"] }
//    (scoring this externally: protein 15 + veg 10 + carbs 0 = 25 total)
